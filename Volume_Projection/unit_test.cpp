...
int main(){
	...
	std::cout << "Max_projecton_finished!" << std::endl;
	proj.IP("min", "unit_test.png", 0, 3, "test");
	std::cout << "Min_projecton_finished!" << std::endl;
	proj.IP("mean", "unit_test.png", 0, 3, "test");
	std::cout << "Mean_projecton_finished!" << std::endl;
	proj.IP("median", "unit_test.png", 0, 3, "test");
	std::cout << "Median_projecton_finished!" << std::endl;
